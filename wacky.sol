...
/**
 *https://twitter.com/WackyCoin
*/

/**
 *https://t.me/WackyCoinOfficial
*/
...
contract Wacky is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    WackyDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Wacky", "WKY") {
        marketingWallet = payable(0xf0EFab99f8FB970aAe79ca0e1972e38E17dA958D);
        devWallet = payable(0x2B6C1f1a9A1B5F7e61F652311ea5984CDDd34B94);
        ...
        dividendTracker = new WackyDividendTracker(
            payable(this),
            router,
        ...
        swapTokensAtAmount = totalTokenSupply / 200000;
    ...
    function updateFees(
        ...
        require(totalSellFees <= 11 && totalBuyFees <= 11, "total fees cannot exceed 11% sell or buy");
...
contract WackyDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        WackyContract = Wacky(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Wacky_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Wacky_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Wacky contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(WackyContract);

            uint256 prevBalance = WackyContract.balanceOf(address(this));
            ...
            {
                uint256 received = WackyContract
